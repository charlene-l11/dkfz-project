...
class CombinationTests(unittest.TestCase):
    ...
    def test_completed_folder_uses_percentage_and_wavelengths(self):
        run = CombinationRun((500.0, 505.0, 510.0))

        self.assertEqual(_completed_folder_name(run, 0.9234), "92.34%; 500+505+510")
        self.assertEqual(_completed_folder_name(run, 0.0525), "05.25%; 500+505+510")
    ...
    def test_runs_rename_by_accuracy_and_results_are_sorted(
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn("90.00%; 500+510", parameters["best_checkpoint"])
